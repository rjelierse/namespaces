 ...
 * - $namespaces: Available namespaces to use for adding data to the HTML
 *   structure of the page. This is mainly used for extra metadata.
 *
 * Site identity:
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>" <?php print $namespaces ?>>
